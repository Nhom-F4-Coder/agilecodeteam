...
values ('SP01','IPHONE 7',50,7000000,5,'01-01-2010','NEW','XỊN XÒ CON BÒ'),
							('SP02','IPHONE 6',50,6000000,10,'01-01-2008','NEW','Màn hình:LED-backlit IPS LCD, 4.7", CPU:Apple A8 2 nhân RAM:	1 GB Bộ nhớ trong:	16 GB'),
							('SP03','IPHONE 5',50,5000000,5,'01-01-2008','NEW','Màn hình:LED-backlit IPS LCD, 4.7",  CPU:Apple A8 2 nhân RAM:	1 GB Bộ nhớ trong:	16 GB'),
							('SP04','IPHONE 8',50,9000000,10,'01-01-2018','NEW','Màn hình:LED-backlit IPS LCD, 4.7",  CPU:Apple A8 2 nhân RAM:	1 GB Bộ nhớ trong:	16 GB'),
							('SP05','IPHONE 10',50,1000000,5,'01-01-2019','NEW','Màn hình:LED-backlit IPS LCD, 4.7", CPU:Apple A8 2 nhân RAM:	1 GB Bộ nhớ trong:	16 GB'),
							('SP06','IPHONE 11',50,10000000,10,'01-01-2020','NEW','Màn hình:LED-backlit IPS LCD, 4.7", CPU:Apple A8 2 nhân RAM:	1 GB Bộ nhớ trong:	16 GB'),
...
values('OS01','SP01','KH0001',N'Nguyễn Văn Đạt','0363402920','2019-2-5','12 Tháng','2020-5-5',1),
	  ('OS02','SP02','KH0002',N'Nguyễn Văn Đạt','01938413849','2019-10-5','3 Tháng','2020-5-5',1),
      ('OS03','SP03','KH0002',N'Nguyễn Văn Đạt','0363402920','2020-5-5','6 Tháng','2020-5-5',1),
      ('OS04','SP04','KH0002',N'Nguyễn Văn Đạt','0363402920','2019-8-5','9 Tháng','2020-5-5',1),
      ('OS05','SP05','KH0002',N'Nguyễn Văn Đạt','0363402920','2019-5-5','12 Tháng','2020-5-5',1),
      ('OS06','SP06','KH0002',N'Nguyễn Văn Đạt','0363402920','2020-2-5','18 Tháng','2020-5-5',1),
      ('OS07','SP07','KH0002',N'Nguyễn Văn Đạt','0363402920','2020-8-5','6 Tháng','2020-5-5',1)
...
drop view TKDT;
CREATE VIEW TKDT AS
SELECT BAOHANH.MASANPHAM,TENSANPHAM,HOADONCHITIET.SOLUONG, HOADONCHITIET.NGAYMUAHANG,MAKHACHHANG,HOTENKHACHHANG,HOADONCHITIET.TONGTIEN
FROM BAOHANH INNER JOIN SANPHAM ON BAOHANH.MASANPHAM = SANPHAM.MASANPHAM inner join HOADONCHITIET on SANPHAM.MASANPHAM =HOADONCHITIET.MASANPHAM

drop view BieuDo
create view BieuDo as
select HOADONCHITIET.TONGTIEN,TENSANPHAM,NGAYMUAHANG
from HOADONCHITIET inner join SANPHAM on HOADONCHITIET.MASANPHAM = SANPHAM.MASANPHAM
--===============================

select*from HOADONCHITIET
SELECT * FROM BAOHANH
select * from HOADON inner join HOADONCHITIET on HOADON.MAHOADON = HOADONCHITIET.MAHOADON
select * from  SANPHAM inner join HOADONCHITIET on SANPHAM.MASANPHAM = HOADONCHITIET.MASANPHAM where NGAYMUAHANG between '2000-01-01' and '2020-01-01' order by  HOADONCHITIET.SOLUONG desc
